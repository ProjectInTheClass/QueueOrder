...
class MyPageTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        if let userOrdered = userOrdered{
            return userOrdered.count
        }
        return 1
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let userOrdered = userOrdered else{
            let cell = tableView.dequeueReusableCell(withIdentifier: "Empty", for: indexPath)
            cell.textLabel?.text = "주문 정보가 없습니다."
            return cell
        }
        let cell = tableView.dequeueReusableCell(withIdentifier: "MyCustomCell", for: indexPath) as! MyTableViewCell
            ...
            cell.Image1.image = UIImage(named: "하늘색바탕")
        // Configure the cell...
