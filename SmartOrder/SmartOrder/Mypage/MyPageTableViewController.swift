...
class MypageTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return userOrdered.orders.count
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
       ...
       cell.Label1.text = order.orderDate
       cell.Label2.text = caffeList[order.caffeInfo]?.name
       cell.Label3.text = "\(order.price)원"
        // Configure the cell...
        ...
        if (segue.identifier == "DetailViewSegue"){
            ...
            if let destination = segue.destination as? MypageDetailViewController{
                ...
                if let selectedIndex = self.tableView.indexPathForSelectedRow?.row{
                    ...
                    let selectedOrder = userOrdered.orders[selectedIndex] as Order
